...
export default function Exercise() {
  ...
  useEffect(() => {
    ...
    fetch(
      "https://react-11g-87359-default-rtdb.firebaseio.com/posts/-N5ImpItad5o7KfjITb9.json", // esta llave -N5ImpItad5o7KfjITb9 ya noi existe por que se elimino con delete
      {
        method: "DELETE",
      }
    )
